...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('crack segmentation')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/cracks/Test_Images/CFD_001.jpg"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/cracks/Test_Images/CFD_001.jpg"))
        self.right_img.setPixmap(QPixmap("images/cracks/Test_Images/CFD_001.jpg"))
        ...
        up_img_button = QPushButton("submit")
        det_img_button = QPushButton("start testing")
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/cracks/Test_Images/CFD_001.jpg'))
        ...
        self.setTabIcon(0, QIcon('images/cracks/Test_Images/CFD_001.jpg'))
        self.setTabIcon(1, QIcon('images/cracks/Test_Images/CFD_001.jpg'))
    ...
    ***上传图片***
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            cv2.imwrite("images/cracks/Test_Images/CFD_001.jpg", im0)
